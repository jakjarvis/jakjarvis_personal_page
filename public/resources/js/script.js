$(document).ready(function () {
  ...
  const navList = document.querySelector(".nav-button");
  ...
  $(".js--fly-icon").hover(
    function () {
      $(".interest-text").append(
        $(
          "<span>I have enjoyed my pilots license since 2006 and flown hundreds of hours over three continents.</span>"
        )
      );
    },
    function () {
  ...
  $(".js--code-icon").hover(
    function () {
      $(".interest-text").append(
        $(
          "<span>Check out my github for all my Python and html projects!</span>"
        )
      );
    },
    function () {
  ...
  $(".js--stem-icon").hover(
    function () {
      $(".interest-text").append(
        $(
          "<span>Interviewer and mentor for the Arkwright Scholarship Trust.</span>"
        )
      );
    },
    function () {
  ...
  $(".js--tool-icon").hover(
    function () {
      $(".interest-text").append(
        $(
          "<span>Owning a 1971 VW beetle and a Motorbike, you need to know how to fix everything!</span>"
        )
      );
    },
    function () {
  ...
  $(".js--music-icon").hover(
    function () {
      $(".interest-text").append(
        $("<span>Usually playing bass or piano in a Jazz band.</span>")
      );
    },
    function () {
      $(".interest-text").find("span").last().remove();
  ...
  $(".js--hurl-icon").hover(
    function () {
      $(".interest-text").append(
        $("<span>Team and committee member for Berlin Setanta GAA.</span>")
      );
    },
    function () {
      $(".interest-text").find("span").last().remove();
